...
CREATE DATABASE "/home/kaduev/Coding/study/db/Data/Schedule.fdb" user 'SYSDBA' password 'masterkey' DEFAULT CHARACTER SET UTF8;
...
(
	...
	roles integer NOT NULL, --UWR
	--U - user modify privilegies
	--W - write privilegies
	--R - read privilegies
