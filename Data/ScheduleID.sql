...
CONNECT "/home/kaduev/Coding/study/db/Data/Schedule.fdb" user 'SYSDBA' password 'masterkey';

CREATE GENERATOR Users_ID;
SET TERM ^ ;
CREATE TRIGGER User_ID FOR Users ACTIVE
BEFORE INSERT POSITION 1
AS BEGIN
	if (new.id is null) then
	new.id = gen_id(Users_ID, 1);
END^
SET TERM ; ^
