...
begin
  ...
  with MData do begin
    with AddTable('Users', 'Пользователи') do begin
      AddField(True, 'ID', 'ID', 40, dtInt);
      AddField(True, 'login', 'Логин', 130, dtStr);
      AddField(True, 'pass', 'Пароль', 130, dtStr);
      AddField(True, 'roles', 'Разрешения', 50, dtInt);
    end;
